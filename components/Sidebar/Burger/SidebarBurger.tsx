    ...
    <div className="relative">
      {
        ...
        <BurgerItem Tag={Link} title="Настройки" href="/profile/settings" />
        <BurgerItem Tag={Link} title="Сохраненное" href="/profile/saved" />
        <BurgerItem Tag={Link} title="Ваши действия" href="/profile/actions" />
      ...
      <div onClick={() => setIsShowMenu(!isShowMenu)} className="sidebar-burger flex items-center gap-3 cursor-pointer" style={style}>
