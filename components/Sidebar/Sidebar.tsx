...
const Sidebar: FC = () => {
  return (
    <div className="sidebar fixed left-0 top-[auto] md:top-0 bottom-0 min-w-[100%] h-[50px] md:h-[100%] bg-[#fff] py-4 px-4 md:min-w-[auto] max-w-[78px] min-[1100px]:min-w-[240px] xl:max-w-[20%] w-[100%]">
      <Link
